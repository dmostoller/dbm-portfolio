    ...
    <div className="max-w-xs sm:max-w-xl md:max-w-2xl lg:max-w-5xl mx-auto p-2 sm:p-3 md:p-4">
      <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-6 gap-2 sm:gap-3 md:gap-4 font-dos">
        <a 
          ...
          className="hover:bg-[var(--button-bg)] hover:text-terminal-color text-md sm:text-base px-2 sm:px-4 py-2 sm:py-2 text-center border border-[var(--terminal-color)]"
        >
          [GITHUB]
        </a>
        <a 
    ...
    return (
      <Drawer.Root>
        <Drawer.Trigger className="fixed bottom-10 left-0 right-0 h-4 flex justify-center">
          <div 
            className="px-4 py-2 w-44 text-sm font-semibold bg-[var(--button-bg)] font-dos"
          >
            Connect With Me
          </div>
        </Drawer.Trigger>
