...
} from "@/components/icons/terminal";
...
export default function CommandPrompt({ onCommand }: CommandPromptProps) {
  ...
  useEffect(() => {
    ...
    // Start continuous animation for the terminal icon cursor
    terminalIconRef.current?.startAnimation();
  }, []);
  ...
  return (
    <>
      ...
      <div className="flex items-start font-dos relative">
        {/* <span className="text-lg">%</span> */}
        <TerminalIcon
          ref={terminalIconRef}
          className="cursor-default p-0 hover:bg-transparent inline-flex"
          style={{
            width: "20px",
            height: "20px",
            marginLeft: "0px",
        ...
        <input
          ...
          className="bg-transparent caret-transparent border-none outline-none pl-0 ml-0 font-dos w-full"
          autoFocus
        />
      </div>
    </>
