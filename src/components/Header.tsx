          ...
          <nav className="flex flex-col gap-2 px-4">
            <Link 
              ...
              className={`p-2 text-lg ${
                pathname === "/" ? "bg-[var(--button-bg)]" : "hover:bg-[var(--button-bg)]"
              }`}
            >
              C:\\&gt; HOME.EXE
            </Link>
            <Link 
              ...
              onClick={() => setIsMenuOpen(false)}
              className={`p-2 text-lg ${
                pathname === "/about" ? "bg-[var(--button-bg)]" : "hover:bg-[var(--button-bg)]"
              }`}
            >
              C:\\&gt; ABOUT.TXT
            </Link>
            <Link 
              ...
              onClick={() => setIsMenuOpen(false)}
              className={`p-2 text-lg ${
                pathname === "/blog" ? "bg-[var(--button-bg)]" : "hover:bg-[var(--button-bg)]"
              }`}
            >
              C:\\&gt; BLOG.TXT
            </Link>
            <Link 
              ...
              onClick={() => setIsMenuOpen(false)}
              className={`p-2 text-lg ${
                pathname === "/projects" ? "bg-[var(--button-bg)]" : "hover:bg-[var(--button-bg)]"
              }`}
            >
              C:\\&gt; PROJECTS.DIR
            </Link>
            <Link 
              ...
              onClick={() => setIsMenuOpen(false)}
              className={`p-2 text-lg ${
                pathname === "/resume" ? "bg-[var(--button-bg)]" : "hover:bg-[var(--button-bg)]"
              }`}
            >
              C:\\&gt; RESUME.PDF
            </Link>
